...
/**
 * uses SequentialSearchST to implement a linear probing hash table
 */
public class LinearProbingHashST<Key, Value> {
    ...
    public static void main(String[] args) {
        LinearProbingHashST<String, Integer> lph = new LinearProbingHashST<>();
        ...
        System.out.println(lph.size() + " " + lph.m + " " + lph.n);
        for (String key : lph.keys()) {
            System.out.println(key + ": " + lph.get(key));
        }
    }
}
/******************************************************************************
